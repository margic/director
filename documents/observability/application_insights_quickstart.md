...
Application Insights is configured with the following settings (in `.env`):
...
**Note:** Obtain the actual instrumentation key and application ID from Azure Portal → Application Insights.
